...
export const pdfDocumentService = {
  ...
  async getQuote(id: string): Promise<QuotePdfDto | null> {
    ...
    return {
      ...
      customer: {
        name: quote.serviceOrder.customer.name,
        document: quote.serviceOrder.customer.document,
        email: quote.serviceOrder.customer.email,
        phone: quote.serviceOrder.customer.phone,
      },
      equipment: {
        type: quote.serviceOrder.equipment.type,
        name: formatEquipmentName(quote.serviceOrder.equipment),
        serialNumber: quote.serviceOrder.equipment.serialNumber,
      },
