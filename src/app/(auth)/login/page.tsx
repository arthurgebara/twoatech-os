...
export default function LoginPage() {
  return (
    <main className="relative min-h-dvh overflow-hidden bg-background">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_15%_20%,color-mix(in_oklch,var(--foreground)_7%,transparent),transparent_28%),radial-gradient(circle_at_85%_80%,color-mix(in_oklch,var(--foreground)_5%,transparent),transparent_26%)]" />
